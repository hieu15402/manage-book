...
public enum ErrorCode {
    ...
    DUPLICATE_ISBN(400, "ISBN must be unique", HttpStatus.BAD_REQUEST),
    INVALID_AUTHOR_ID(400, "Author may be null or do not exist", HttpStatus.BAD_REQUEST),
    INVALID_BOOK_ID(400, "Book may be null or do not exist", HttpStatus.BAD_REQUEST),
